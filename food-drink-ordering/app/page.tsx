...
export default function HomePage() {
  ...
  const [activeCategory, setActiveCategory] = useState<"drinks" | "food">("drinks")
          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <h1 className="text-2xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
                ร้านแสนดีชานมไข่มุก By debugger
              </h1>
              ...
              >
                <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 bg-white/70 backdrop-blur-sm border-0 shadow-lg hover:shadow-orange-200/50">
                  ...
                  <CardContent className="p-4">
                    <CardTitle className="text-lg mb-2 text-gray-800">{item.name}</CardTitle>
        ...
        <AnimatePresence>
          {cart.length > 0 && (
            ...
            >
              ...
              >
                <div className="text-sm text-gray-600 mb-2">รวม {getTotalItems()} รายการ</div>
                <motion.div
                  key={getTotalPrice()}
