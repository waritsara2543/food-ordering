        ...
        >
          <Card className="w-full max-w-md bg-white/80 backdrop-blur-sm shadow-2xl border-0">
            <CardContent className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold mb-4 text-gray-800">ตะกร้าว่าง</h2>
        ...
        >
          ...
          >
            <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
              <CardHeader>
                <CardTitle className="flex items-center text-gray-800">🛍️ รายการสินค้า</CardTitle>
              </CardHeader>
          ...
          >
            <Card className="bg-white/80 backdrop-blur-sm shadow-xl border-0">
              <CardHeader>
                <CardTitle className="flex items-center text-gray-800">👤 ข้อมูลลูกค้า</CardTitle>
              </CardHeader>
              ...
              <div className="p-6">
                ...
                >
                  <div className="bg-white rounded-xl shadow-lg p-4 inline-block">
                    <img src="/qr-payment.jpg" alt="QR Code สำหรับชำระเงิน" className="w-64 h-auto mx-auto rounded-lg" />
                  </div>
                  <p className="text-sm text-gray-600 mt-3">สแกน QR Code ด้วยแอปธนาคารของคุณ</p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <h3 className="font-semibold text-gray-800 flex items-center">📄 อัปโหลดสลิปการโอนเงิน</h3>
                    ...
                    <label htmlFor="payment-slip" className="cursor-pointer block">
                      {paymentSlipPreview ? (
                        <div className="space-y-3">
                          ...
                          />
                          <p className="text-sm text-green-600 font-medium">✅ อัปโหลดสลิปเรียบร้อย</p>
                ...
                >
                  <Button variant="outline" onClick={() => setShowPayment(false)} className="flex-1 hover:bg-gray-50">
                    ยกเลิก
                  </Button>
                  <Button
              ...
              <div className="p-6">
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4">
                    <h3 className="font-semibold text-gray-800 mb-3 flex items-center">📋 รายละเอียดออเดอร์</h3>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-gray-600">หมายเลขออเดอร์:</span>
                        <span className="font-mono text-blue-600">#{completedOrder.id.slice(-8).toUpperCase()}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">วันที่สั่ง:</span>
                        <span className="font-medium">
                          {new Date(completedOrder.created_at).toLocaleDateString("th-TH")}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">เวลา:</span>
                        <span className="font-medium">
                          {new Date(completedOrder.created_at).toLocaleTimeString("th-TH")}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4">
                    <h3 className="font-semibold text-gray-800 mb-3 flex items-center">👤 ข้อมูลลูกค้า</h3>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{completedOrder.customer_phone}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-4">
                    <h3 className="font-semibold text-gray-800 mb-3 flex items-center">🛍️ รายการสินค้า</h3>
                    <div className="space-y-2">
                      {completedOrder.order_items.map((item, index) => (
                        ...
                        >
                          <div>
                            <span className="font-medium text-gray-800">{item.menu_item_name}</span>
                            <span className="text-gray-600 ml-2">x{item.quantity}</span>
                          </div>
                          <span className="font-medium text-green-600">฿{item.menu_item_price * item.quantity}</span>
                        </motion.div>
                      ))}
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-green-600">฿{completedOrder.total}</span>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <span className="text-yellow-700 font-medium">สถานะ: รอการตรวจสอบการชำระเงิน</span>
                    </div>
                    <p className="text-center text-sm text-yellow-600 mt-2">เราจะตรวจสอบสลิปการโอนเงินและแจ้งผลให้ทราบ</p>
                  </motion.div>
                </div>
                ...
                <motion.div
                  ...
                  className="flex space-x-3 mt-6"
                >
                  <Button variant="outline" onClick={() => setCompletedOrder(null)} className="flex-1 hover:bg-gray-50">
                    สั่งซื้อเพิ่ม
                  </Button>
                  <Button
                    onClick={() => {
